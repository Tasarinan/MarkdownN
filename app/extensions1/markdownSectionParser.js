define([
  ...
  var markdownSectionParser = new Extension("markdownSectionParser",
  ...
  markdownSectionParser.onPagedownConfigure = function (editor) {
    ...
    if (mathJax.enabled) {
      ...
      regexp =
        ...
        regexp; // \\begin{...} \\end{...} math block delimiters
    }
      ...
      editor.hooks.chain("onPreviewRefresh", function () {
        ...
        function createSectionElt() {
          ...
          while (childNode) {
            ...
            var isDelimiter = childNode.className ==
              'se-preview-section-delimiter';
            if (isNextDelimiter === true && childNode.tagName ==
              'DIV' && isDelimiter) {
