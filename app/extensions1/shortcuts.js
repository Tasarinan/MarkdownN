define([
	...
	shortcutsSettingsBlockHTML, tooltipSettingsShortcutsExtensionHTML) {
	...
	function bindPagedownButton(buttonName) {
		return function (evt) {
			pagedownEditor.uiManager.doClick(pagedownEditor.uiManager.buttons[
				buttonName]);
			evt.preventDefault();
		};
	}
	...
	shortcuts.onReady = function () {
		utils.createTooltip(".tooltip-shortcuts-extension",
			tooltipSettingsShortcutsExtensionHTML);
	};
